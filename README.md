...
The setup process is divided into separate responsibilities:

- OS package installation
- service configuration
- extra setup for package-managed tools
- installation/setup of tools not handled by the package manager
- distribution-specific package lists and notes

This keeps the setup modular and makes individual parts easier to extend, replace, or reuse.
